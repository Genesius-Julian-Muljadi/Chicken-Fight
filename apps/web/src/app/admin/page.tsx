    ...
    <div className="flex min-h-screen h-auto w-auto flex-col items-center justify-center gap-6">
      ...
      >
        {(props: FormikProps<LoginUser>) => {
          ...
          return (
            <Form className="flex w-[85%] flex-col gap-3 rounded bg-backtheme-50 dark:bg-backtheme-900 px-6 py-8 shadow-lg sm:w-[60%] sm:p-12">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Field
                  ...
                  className={`mt-2 flex h-10 w-full items-center rounded bg-gray-100 px-2 text-sm text-black border dark:border-none focus:outline-1 focus:ring-zinc-600 sm:h-12 sm:px-4 sm:text-base`}
                />
              ...
              <div className="relative mt-8">
                <button
                  type="submit"
                  className="mx-auto flex h-12 items-center justify-center rounded bg-blue-400 dark:bg-blue-600 px-6 text-sm font-semibold text-black dark:text-blue-gray-100 shadow-sm shadow-slate-400 hover:bg-blue-700 sm:w-64"
